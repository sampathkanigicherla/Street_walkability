        ...
        with open(outputFile, 'w', encoding='utf-8') as panoInfoText:
            ...
            for i in range(start, end):
                ...
                if data.get('status') != 'OK':
                    ...
                    continue  # 🔴 SKIP: Do not log anything if status is not OK
...
if __name__ == "__main__":
    root = r'C:\Treepedia_Public-master\india_city_shapefiles\Tirupathi'
    inputShp = os.path.join(root, 'create_points\create_points.shp')
    outputTxt = r'C:\Treepedia_Public-master\india_city_shapefiles\Tirupathi\metadata'
    api_key = 'AIzaSyBlsTOJ0_R9BqM7IfbU5kcgGFmBG2OY7Jc'  # Replace with your actual API key
