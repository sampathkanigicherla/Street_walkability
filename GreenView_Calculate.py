            ...
            with open(GreenViewTxtFile,"w") as gvResTxt:
                for i in range(len(panoIDLst)):
                    ...
                    for heading in headingArr:
                        ...
                        f"size=400x400&pano={panoID}&fov=60&heading={heading}&pitch={pitch}&sensor=false&key={key}"
                    )
...
if __name__ == "__main__":
    ...
    GSVinfoRoot = 'C:\Treepedia_Public-master\spatial-data\metadata1'
    outputTextPath = r'C:\Treepedia_Public-master\spatial-data\greenviewRes1'
    greenmonth = ['01','02','03','04','05','06','07','08','09','10','11','12']
    key_file = 'C:\Treepedia_Public-master\Treepedia\keys.txt'
