...
if __name__ == "__main__":
    ...
    inshp = r'C:\Treepedia_Public-master\india_city_shapefiles\Vijayawada\Vijayawada.shp'
    outshp = r'C:\Treepedia_Public-master\india_city_shapefiles\Vijayawada\create_points'
